...
public interface CustomerRegisterValidator extends Function<Customer, CustomerRegisterValidator.ValidationResult> {
    ...
    static CustomerRegisterValidator isPhoneNumberValid(){
        return customer -> customer.getPhoneNumber().startsWith("9")?ValidationResult.SUCCESS:ValidationResult.PHONE_NUMBER_NOT_VALID;
    }
